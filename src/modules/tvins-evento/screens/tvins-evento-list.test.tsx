// Escenarios observables — Gestión de la tabla tvins_evento.
// (El frontend no tiene runner; estos escenarios son el holdout que define "hecho".)
//
//   EV-1  /dashboard/tv-data/tvins_evento muestra la lista de tvins_evento: título "tvins_evento",
...
//   EV-5  "Carga masiva" reemplaza toda la tabla; plantilla = plantilla_tvins_evento.xlsx; columnas de
...
//   EV-7  Backend: tabla tvins_evento con FKs a measurement_units (medida y dispensación) y a
