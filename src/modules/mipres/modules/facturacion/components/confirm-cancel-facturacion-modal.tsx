      ...
      >
        <header className="flex items-start justify-between gap-3 border-b border-slate-200 bg-red-50/60 px-5 py-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 id="confirm-cancel-facturacion-title" className="text-base font-bold text-[#2d3436]">
                Anular facturación
              </h2>
        ...
        <div className="px-5 py-4 text-sm text-slate-700">
          <p className="mb-3">
            ...
            <span className="font-mono font-bold text-[#2d3436]">{facturacion.IDFacturacion}</span>?
          </p>
