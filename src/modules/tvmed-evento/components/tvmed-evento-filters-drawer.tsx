...
import { EMPTY_EVENTO_FILTERS, type EventoFilters } from '../types/tvmed-evento.types'
...
export default function TvMedEventoFiltersDrawer({ open, value, onClose, onApply }: Props) {
